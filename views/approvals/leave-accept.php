          ...
          <div class="card-body">
            ...
            <div class="headetails mt-3">
              ...
              <div class="col-md-6 col-lg-6">
                ...
                <form class="m-3" method="POST" action="<?php echo BSURL;?>functions/leave.php?case=acceptleave">
                  ...
                  <div class="form-group">
                    ...
                    <input type="hidden" name="rest" value="<?php echo $lvs['in_afterbalan'];?>">

                    <input type="hidden" name="emi" value="<?php echo $lvs['in_empid'];?>">

                    <input type="hidden" name="prid" value="<?php echo $pr;?>">

                    <label class="text-success" for="accept">
                    <input type="radio" name="formaccept" value="1" required id="accept"> Accept</label>

                    <label class="text-danger" for="reject">
                    <input type="radio" name="formaccept" value="2" required class="ml-4" id="reject"> Reject</label>
                  ...
                  <div class="form-group">
                    <label>Comment*</label>
                    <textarea class="form-control" name="comment" required rows="2"></textarea>
