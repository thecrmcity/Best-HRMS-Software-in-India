      ...
      <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="empinfo">
              ...
              <div class="templist">
                <ul class="nav flex-column">
                  <?php
                  $table = "in_templates";
                  $cond = " `in_comid`='$comid' AND `in_temptype`='document' ";
                  ...
                  if(!empty($list))
                  {
                    foreach($list as $ls)
                    {
                      ...
                      {
                        ?>
                        <li class="nav-item nav-setard"><a href="<?php echo VIEW.$pagename?>/document-templates.php?id=<?php echo $ls['in_sno'];?>" class="nav-link"><i class="fas fa-angle-double-right"></i> <?php echo $ls['in_tempname'];?>
                      ...
                      {
                        ?>
                        <li class="nav-item nav-petard"><a href="<?php echo VIEW.$pagename?>/document-templates.php?id=<?php echo $ls['in_sno'];?>" class="nav-link"><i class="fas fa-angle-double-right"></i> <?php echo $ls['in_tempname'];?>
          ...
          <div class="col-lg-9 col-md-9">
            <div class="empinfo">
              <div class="form-group mb-3" style="border-bottom:1px solid #c1c1c1;padding-bottom: 5px;">
                  <small class="font-italic text-danger">
                  <span class="text-dark">Employee Info</span> [EMPID], [NAME], [BTHDATE], [ANIDATE], [LOGTIME], [OUTTIME], [POST], [DEPARTMENT], [INACTIVEDATE], [JOININGDATE], [EXPRIENCE], [EMPADDRESS], [LASTEDUCATION], [EMPEMAIL], [EMPMOBILE] <br>
                  <span class="text-dark">Company Info</span> [COMPANY], [COMADDRESS], [COMEMAIL], [COMCINNO], [COMTINNO], [COMGSTNO] <br>
                  <span class="text-dark">Date&Time Info</span> [CURRENTDATE], [SENTDATE], [MODIFYDATE], [SUBJECT]<br>
                  </small> 
                </div>
