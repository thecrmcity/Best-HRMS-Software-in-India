        ...
        <div class="card rounded-0">
          ...
          <div class="card-header">
            ...
            <div class="card-tools">
              ...
              <a href="<?php echo VIEW?>approvals/leave-approval.php" class="font-weight-bold"><i class="fas fa-hourglass-half"></i> Pending Leaves</a>
                ...
                <tbody>
...

                  {
...

                    {
                      ...
                      <td><?php echo $lv['in_startdate'];?></td>

                      <td><?php echo $lv['in_enddate'];?></td>
                      ...
                      <td><?php
                       ...
                       $stat = $lv['in_approvstatus'];
...

                        {
                          ...
                          echo '<div class="text-success font-weight-bold">Leave Accepted</div>';

                          break;

                          case "2":

                          echo '<div class="text-danger font-weight-bold">Leave Rejected</div>';

                          break;

                          case "3":

                          echo '<div class="text-primary font-weight-bold">Leave Cancelled</div>';
                      ...
                      <td><?php echo $lv['in_approvedate'];?></td>
                      <td>
                        <?php
                        $stat = $lv['in_approvstatus'];
                        if($stat == "1")
                        {
                          ?>
                          <a href="<?php echo VIEW.$pagename?>/drop-leave.php?id=<?php echo $lv['in_sno']?>" class="badge badge-danger"><i class="fa fa-trash"></i> Drop Leave</a>
                          <?php
                        }
