          ...
          <div class="col-sm-2 col-md-2">
            <div class="info-box fillbox">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $weeshol+$holday+($daycont-$latins);?> Days</span>
              </div>
            ...
            <div class="table-responsive">
              ...
              <table class="table table-bordered table-striped">
                ...
                <?php
                  ...
                  for($i=1;$i<=$cday;$i++)
                  {
                    $tblmonth = date('F', strtotime(date('Y-m')));
                    $table = "in_monthly_attend";
                    ...
                    $weekoff = date('l', strtotime(date('Y-m-'.$i)));
                    $wday = $cyer."-".$cmon."-".$i;
                    ...
                    switch($nofweek)
                    {
                      ...
                      <tr class="<?php echo $colored.' '.$holicolor; ?>">
                        ...
                        <td><?php echo date('l', strtotime(date('Y-m-'.$i)));?></td>
