...

                  {
                    ...
                    <div class="form-group row">
                      ...
                      <div class="input-group col-sm-8">
                        ...
                        <select class="form-control rounded-0" name="comname" required id="compgroup">
              ...
              ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      <input type="text" class="form-control rounded-0" placeholder="Name" name="fname" required value="<?php echo $res['in_fname'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      <input type="text" class="form-control rounded-0" placeholder="Name" name="lname" value="<?php echo $res['in_lname'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      <input type="text" class="form-control rounded-0" placeholder="Father Name" name="fthername" value="<?php echo $res['in_fathernam'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      <input type="email" class="form-control rounded-0" placeholder="Email" name="useremail" required value="<?php echo $res['in_email'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
                    ...
                    <input type="hidden" name="dateofbirth" id="dateofbirth" value="<?php echo $res['in_dateofbirth'];?>">
...

                    {
                      ...
                      <input type="date" class="form-control rounded-0" name="dateofbirth" value="<?php echo $res['in_dateofbirth'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      <input type="tel" class="form-control rounded-0" placeholder="Mobile" name="mobileone" required value="<?php echo $res['in_mobileno'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
                    ...
                    <input type="hidden" name="gender" value="<?php echo $res['in_gender'];?>">
                    <select class="form-control rounded-0" name="gender" disabled>

                      <option value="<?php echo $res['in_gender'];?>"><?php echo $res['in_gender'];?></option>
                 ...
                 <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
                    ...
                    <select class="form-control rounded-0" name="marital" required >
                      ...
                      <option value="<?php echo $res['in_marital'];?>"><?php echo $res['in_marital'];?></option>
                  ...
                  <input type="hidden" name="marital" value="<?php echo $res['in_marital'];?>">
                    <select class="form-control rounded-0" name="marital" required disabled>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      ?>
                    <input type="hidden" name="profile" value="<?php echo $res['in_photo'];?>">
                    <input type="file" class="form-control rounded-0" name="profile" value="<?php echo $res['in_photo'];?>" disabled>
              ...
              <div class="card rounded-0">
                ...
                <div class="card-body">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      ?>
                      <input type="hidden" name="wcategory" value="<?php echo $res['in_childid'];?>">
                      <select class="form-control rounded-0" name="wcategory" required disabled>

                      <option value="<?php echo $res['in_childid'];?>"><?php echo $cats['in_prefix'];?></option>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
                    ...
                    <input type="hidden" class="form-control rounded-0" name="dateofjoin" id="dateofjoin" value="<?php echo $res['in_dateofjoining'];?>">
...

                    {
                      ...
                      <input type="date" class="form-control rounded-0" name="dateofjoin" required value="<?php echo $res['in_dateofjoining'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
                    <select name="probation" class="form-control rounded-0">
                      <option value="">--Select--</option>
                      <?php
                      for($p=1;$p<=12;$p++)
                      {
                        $talval = $p*30;
                        ?>
                        <option value="<?php echo $talval;?>" <?php echo $probatime == $talval ? "Selected":""; ?>><?php echo $talval;?> Days</option>
                        <?php
                      }
                      ?>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      ?>
                      <input type="hidden" name="wlocation" value="<?php echo $res['in_worklocation'];?>">
                      <select class="form-control rounded-0" name="wlocation" required disabled>

                      <option value="<?php echo $res['in_worklocation'];?>"><?php echo $wlocs['in_prefix'];?></option>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      ?>
                      <input type="hidden" name="department" value="<?php echo $res['in_department'];?>">
                      <select class="form-control rounded-0" name="department" required disabled>

                      <option value="<?php echo $res['in_department'];?>"><?php echo $depart['in_prefix'];?></option>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      ?>
                      <input type="hidden" name="designation" value="<?php echo $res['in_designation'];?>">
                      <select class="form-control rounded-0" name="designation" required disabled>

                      <option value="<?php echo $res['in_designation'];?>"><?php echo $desi['in_prefix'];?></option>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      ?>
                       <input type="hidden" name="reporting" value="<?php echo $res['in_reporting'];?>">
                      <select class="form-control rounded-0" name="reporting" disabled>

                      <option value="<?php echo $res['in_reporting'];?>"><?php echo $mnge['in_prefix'];?></option>

                      <?php

                        $table = "in_master_card";

                        $cond = " `in_relation`='reporting' ";
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      ?>
                      <input type="hidden" name="role" value="<?php echo $res['in_groupid'];?>">
                      <select class="form-control rounded-0" name="role" required id="mainrole" disabled>

                      <option value="<?php echo $res['in_groupid'];?>"><?php echo $role['in_cardname'];?></option>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      <input type="password" class="form-control rounded-0" name="salary" placeholder="Salary" required value="<?php echo $res['in_salary'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      ?>
                      <input type="hidden" name="payscale" value="<?php echo $res['in_payscale'];?>">
                      <select class="form-control rounded-0" name="payscale" required disabled>

                      <option value="<?php echo $res['in_payscale'];?>"><?php echo $pys['in_namescle'];?></option>
              ...
              <div class="card rounded-0">
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
...

                    {
                      ...
                      <input type="text" class="form-control rounded-0" name="panno" placeholder="Pan No" id="propan" onkeyup="propanno()" maxlength="10" value="<?php echo $res['in_panno'];?>" readonly>
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
                    ...
                    <input type="hidden" class="form-control rounded-0" name="pfdate" id="pfeffective" value="<?php echo $res['in_pfeffective'];?>">
                ...
                <div class="form-group row">
                  ...
                  <div class="input-group col-sm-8">
                    ...
                    <input type="hidden" class="form-control rounded-0" name="esidate" id="esieffective" value="<?php echo $res['in_esiceffective'];?>">
