            ...
            <div class="clearfix">
              ...
              <div class="station">
                  ...
                  <ul class="stationav">
                    ...
                    <li><a href="<?php echo VIEW.$pagename?>/manage-employee.php">All<span class="text-secondary">(<?php echo count($cAll);?>)</span></a></li>

                    <li><a href="<?php echo VIEW.$pagename?>/active-employee.php">Active<span class="text-secondary">(<?php echo count($aAll);?>)</span></a></li>

                    <li><a href="<?php echo VIEW.$pagename?>/inactive-employee.php">Inactive<span class="text-secondary">(<?php echo count($xAll);?>)</span></a></li>
...

                  {
...

                    {
...

                      {
                        ...
                        echo "<span class='badge badge-pill text-success'><i class='fas fa-lock'></i> Accessed</span>";

                        break;

                        case "0":

                        echo "<a href='".VIEW."employee/set-password.php?id=".$rs['in_empid']."' class='badge badge-pill text-primary'><i class='fas fa-unlock-alt'></i> Password</a>";

                        break;

                        case "2":

                        echo "<a href='".BSURL."functions/employee.php?case=resetpass&id=".$rs['in_empid']."' class='badge badge-pill badge-warning'><i class='fas fa-bug'></i> Request</a>";
