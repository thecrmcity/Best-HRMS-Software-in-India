        ...
        <!-- Small boxes (Stat box) -->
          ...
          <div class="card-header">
            <div class="text-center">
              <!-- <i class="fas fa-donate"></i>  -->Pre Computation
            </div>
            ...
            <!-- <div class="row mb-2">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  <label>Employee ID : 444</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Employee Name : Gurpreet Kaur</label>

                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Email Address : gurpreet.kaur@inoday.com</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Mobile Number: 807762222</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Designation : Functional Consultant </label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>PAN :CTUGE1616I </label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>DOJ : 01/2/2023</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            ...
                            <input type="text" name="salary" class="form-control rounded-0" required placeholder="720000">
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            <span class="form-control rounded-0" readonly id="chapterdeduct">50000</span>
                          </div>
                        </div>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-2">
                            ...
                            <input type="number" name="" class="form-control rounded-0 deductchap" id="deduct1" placeholder="70000">
                          </div>
                        </div>
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-2">
                            ...
                            <input type="number" name="" class="form-control rounded-0 deductchap" id="deduct2" placeholder="70000">
                          </div>
                        </div>
                        <div class="form-group row">
