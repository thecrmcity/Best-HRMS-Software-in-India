          ...
          <div class="card-body">
            <!-- <div class="row mb-2">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  <label>Mobile Number: 807768224</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Designation : PHP </label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>PAN :PEVFV4506Y </label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>DOJ : 01/01/2023</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            ...
                            <input type="text" name="salary" class="form-control rounded-0" required placeholder="48000">
                          </div>
                        </div>
                        <div class="form-group row">
