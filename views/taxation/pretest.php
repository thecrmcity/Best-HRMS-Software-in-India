          ...
          <div class="card-body">
            <!-- <div class="row mb-2">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  <label>Email Address : tina.rani@inoday.com</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Mobile Number: 807762225</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Designation : Developer </label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>PAN :XGZFE7225A </label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>DOJ : 01/09/2022</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            ...
                            <input type="text" name="salary" class="form-control rounded-0" required placeholder="600000">
                          </div>
                        </div>
                        <div class="form-group row">
