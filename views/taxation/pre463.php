            ...
            <!-- <div class="row mb-2">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  <label>Employee ID : 463</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Employee Name : Mahipal Singh</label>

                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Email  : mahipal.singh@inoday.com</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Mobile Number: 907762225</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Designation : Software Developer </label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>PAN : DAJPC4150P</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>DOJ : 01/12/2023</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            ...
                            <input type="text" name="salary" class="form-control rounded-0" required placeholder="576000">
                          </div>
                        </div>
                        <div class="form-group row">
