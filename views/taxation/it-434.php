            ...
            <!-- <div class="row mb-2">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  <label>Employee ID : 434</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Employee Name : Tina Rani</label>

                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Email : tina.rani@inoday.com</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Mobile Number: 907788224</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            ...
                            <input type="text" name="salary" class="form-control rounded-0" required placeholder="50000">
                          </div>
                        </div>
                        <div class="form-group row">
                     ...
                     <span class="form-control rounded-0" readonly id="chapterdeduct" >0</span>
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-2">
                            ...
                            <input type="number" name="" class="form-control rounded-0 deductchap" id="deduct1" placeholder ="">
                          </div>
                        </div>
                        <div class="form-group row">
