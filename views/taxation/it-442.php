            ...
            <!-- <div class="row mb-2">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  <label>Employee ID : 442</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Employee Name : Gurpreet Kuar</label>

                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Email : gurpreet.kaur@inoday.com</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Mobile Number: 907768234</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            ...
                            <input type="text" name="salary" class="form-control rounded-0" required placeholder="60000">
                          </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            <span class="form-control rounded-0" readonly id="chapterdeduct">70000</span>
                          </div>
                        </div>
