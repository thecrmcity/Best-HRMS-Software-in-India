            ...
            <!-- <div class="row mb-2">
              ...
              <div class="row">
                ...
                <div class="col-lg-4 col-md-4">
                  <label>Employee ID : 461</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Employee Name : Sonu kumar</label>

                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Email Address : sonu.kumar@inoday.com</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Mobile Number: 897762225</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>Designation : Web Designer </label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>PAN : BAJPC4350M</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  <label>DOJ : 01/05/2023</label>
                </div>
                <div class="col-lg-4 col-md-4">
                  ...
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            ...
                            <input type="text" name="salary" class="form-control rounded-0" required placeholder="480000">
                          </div>
                        </div>
                        <div class="form-group row">
                   ...
                   <span class="form-control rounded-0" id="standeduct" readonly></span>
                        ...
                        <div class="my-2">
                          ...
                          <div class="form-group row">
                            ...
                            <div class="input-group col-sm-2">
                              ...
                              <input type="text" name="" class="form-control rounded-0 deductsn" placeholder="5000">
                            </div>
                          </div>
                          <div class="form-group row">
                        ...
                        <div class="form-group row">
                          ...
                          <div class="input-group col-sm-3">
                            <span class="form-control rounded-0" readonly id="chapterdeduct">0</span>
                          </div>
                        </div>
                  ...
                  <div class="card-footer p-0">
                    <table style="width: 100%;" cellpadding="5px" cellspacing="5px" border="1">
                      <tr>
                        ...
                        <!-- <td width="27%"><?php echo $salary;?></td> -->
                        <td width="27%">43000</td>
                      </tr>
                      <tr>
                        <th>Income Tax</th>
                        <td>&nbsp;<?php echo $tax;?></td>
