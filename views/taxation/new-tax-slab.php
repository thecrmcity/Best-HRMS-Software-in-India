    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="card rounded-0">
          ...
          <div class="card-body">
            <form class="" method="POST" action="<?php echo BSURL;?>functions/taxation.php?case=addslab">
                ...
                <div class="input-group col-sm-4">
                  <select class="form-control" required name="finanace">
                    ...
                    for($i=1;$i<=10;$i++)
                    {
                      ...
                      ?>
                      <option value="<?php echo $fullyear;?><?php echo "-".$oneyear;?>"><?php echo $fullyear;?><?php echo "-".$oneyear;?></option>
                      <?php
                      $s++;
                    }
                    ?>
