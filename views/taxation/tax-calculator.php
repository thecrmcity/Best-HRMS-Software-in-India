              ...
              <div class="col-lg-7 col-md-7">
                <form class="" method="GET" action="" enctype="multipart/form-data">
                  <div class="form-group row">
                        ...
                        <div class="form-group row">
                          <label class="col-sm-7 col-form-label">Income from Salary*</label>
                          <div class="input-group col-sm-5">
                            <div class="input-group-prepend">
                        ...
                        <div class="p-2 my-2" style="background: #b3e1fd69;">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-6 col-form-label">Column A</label>
                            <div class="input-group col-sm-4">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-6 col-form-label">Column B</label>
                            <div class="input-group col-sm-4">
                          ...
                          <div class="form-group row">
                            <label class="col-sm-6 col-form-label">Column C</label>
                            <div class="input-group col-sm-4">
