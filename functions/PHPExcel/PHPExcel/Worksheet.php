...
class PHPExcel_Worksheet implements PHPExcel_IComparable
{
    ...
    */
    ...
    public function setSelectedCells($pCoordinate = 'A1')
    {
        ...
        // Convert 'A' to 'A:A'
        $pCoordinate = preg_replace('/^([A-Z]+)$/', '$[2]:$[2]', $pCoordinate);

        // Convert '1' to '1:1'
        $pCoordinate = preg_replace('/^([0-9]+)$/', '$[2]:$[2]', $pCoordinate);

        // Convert 'A:C' to 'A1:C1048576'
        $pCoordinate = preg_replace('/^([A-Z]+):([A-Z]+)$/', '$[2]1:$[2]1048576', $pCoordinate);

        // Convert '1:3' to 'A1:XFD3'
        $pCoordinate = preg_replace('/^([0-9]+):([0-9]+)$/', 'A$[2]:XFD$[2]', $pCoordinate);
